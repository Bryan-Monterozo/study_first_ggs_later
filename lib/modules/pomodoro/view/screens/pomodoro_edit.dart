...
class pomodoroEditPage extends StatefulWidget {
  static const String routeName = '/pomodoro/pomodoro_edit';
  final pomodoroId;
  ...
  State<pomodoroEditPage> createState() => _pomodoroAddPageState();
}

class _pomodoroAddPageState extends State<pomodoroEditPage> {
  ...
  void initState() {
    ...
    PomodoroModel pomodoroModel = widget.pomodoroModel;

    titleController.text = pomodoroModel.title;
    minutesLong = pomodoroModel.minutesLong;
    minutesShort = pomodoroModel.minutesShort;
    minutesRunning = pomodoroModel.minutesRunning;
    secondsLong = pomodoroModel.secondsLong;
    secondsShort = pomodoroModel.secondsShort;
    secondsRunning = pomodoroModel.secondsRunning;
  }
      ...
      appBar: SharedAppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              PomodoroDB().editPomodoroToDB(
                title: titleController.text,
                id: widget.pomodoroId,
